...
export const XDAI_ENDPOINT = 'wss://xdai.poanetwork.dev/wss'

export const IPFS_RPC = 'http://localhost:5001#default'

export const IPFS_LOCAL_GATEWAY = 'http://localhost:8080/ipfs'
export const IPFS_ARAGON_GATEWAY = 'https://ipfs.eth.aragon.network/ipfs'
