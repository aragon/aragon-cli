...
module.exports = async function (dao, method, params, { reporter, apm, network, wsProvider, role }) {
  ...
  return execHandler(dao, getTransactionPath, { reporter, apm, wsProvider, network })
}
